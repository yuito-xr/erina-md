...
erina({ nomCom: "tagall", categorie: 'List 🗿', reaction: "☘️" }, async (dest, zk, commandeOptions) => {
...
erina({ nomCom: "link", categorie: 'List 🗿', reaction: "☘️" }, async (dest, zk, commandeOptions) => {
...
erina({ nomCom: "promote", categorie: 'List 🗿', reaction: "☘️" }, async (dest, zk, commandeOptions) => {
...
erina({ nomCom: "demote", categorie: 'List 🗿', reaction: "☘️" }, async (dest, zk, commandeOptions) => {
  let { repondre, msgRepondu, infosGroupe, auteurMsgRepondu, verifGroupe, auteurMessage, superUser, idBot } = commandeOptions;
  let membresGroupe = verifGroupe ? await infosGroupe.participants : ""
  if (!verifGroupe) { return repondre("For groups only"); }
...
/** ***fin démettre****  **/
/** **retirer** */
erina({ nomCom: "remove", categorie: 'List 🗿', reaction: "☘️" }, async (dest, zk, commandeOptions) => {
    ...
    if (autAdmin || superUser) {
      if (msgRepondu) {
        if (zkad) {
          if (membre) {
            if (admin == false) {
              const gifLink = "https://raw.githubusercontent.com/djalega8000/erina-MD/main/media/remover.gif"
              var sticker = new Sticker(gifLink, {
                pack: 'erina-Md', // The pack name
...
erina({ nomCom: "del", categorie: 'List 🗿',reaction:"🧹" }, async (dest, zk, commandeOptions) => {
...
erina({ nomCom: "info", categorie: 'List 🗿' }, async (dest, zk, commandeOptions) => {
 ...
 erina({ nomCom: "antilink", categorie: 'List 🗿', reaction: "🔗" }, async (dest, zk, commandeOptions) => {
 ...
 erina({ nomCom: "antibot", categorie: 'List 🗿', reaction: "🔗" }, async (dest, zk, commandeOptions) => {
...
erina({ nomCom: "group", categorie: 'List 🗿' }, async (dest, zk, commandeOptions) => {
...
erina({ nomCom: "left", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
erina({ nomCom: "gname", categorie: 'List 🗿' }, async (dest, zk, commandeOptions) => {
...
erina({ nomCom: "gdesc", categorie: 'List 🗿' }, async (dest, zk, commandeOptions) => {
...
erina({ nomCom: "gpp", categorie: 'List 🗿' }, async (dest, zk, commandeOptions) => {
...
/////////////
erina({nomCom:"hidetag",categorie:'List 🗿',reaction:"🎤"},async(dest,zk,commandeOptions)=>{
...
erina({ nomCom: "apk", reaction: "✨", categorie: "Research" }, async (dest, zk, commandeOptions) => {
...
erina({
  ...
  const {arg , repondre , verifAdmin , superUser , veriferinaAdmin } = commandeOptions ;

  if (verifAdmin || superUser) {

    if(!veriferinaAdmin){ repondre('You need administrative rights to perform this command') ; return ;}
