...
zokou({nomCom:"sticker",categorie: "List 🗿", reaction: "🌻"},async(origineMessage,zk,commandeOptions)=>{
...
zokou({nomCom:"scrop",categorie: "List 🗿", reaction: "🌻"},async(origineMessage,zk,commandeOptions)=>{
...
zokou({nomCom:"take",categorie: "List 🗿", reaction: "🌻"},async(origineMessage,zk,commandeOptions)=>{
   const {ms , msgRepondu,arg,repondre,nomAuteurMessage} = commandeOptions ;
...
zokou({ nomCom: "write", categorie: "List 🗿", reaction: "🌻" }, async (origineMessage, zk, commandeOptions) => {
  const { ms, msgRepondu, arg, repondre, nomAuteurMessage } = commandeOptions;
...
zokou({nomCom:"photo",categorie: "List 🗿", reaction: "🌻"},async(dest,zk,commandeOptions)=>{
   const {ms , msgRepondu,arg,repondre,nomAuteurMessage} = commandeOptions ;
...
zokou({ nomCom: "trt", categorie: "List 🗿", reaction: "🌻" }, async (dest, zk, commandeOptions) => {
...
zokou({ nomCom: "url", categorie: "List 🗿", reaction: "🌻" }, async (origineMessage, zk, commandeOptions) => {
